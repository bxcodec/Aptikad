...
//        $matakuliah = AitkRMatakuliah::find()->where(['semester' => $mahasiswa->semester])->all();
        ?>
            ...
            <div class="panel panel-danger">
                ...
                <div id="collapseList" class="panel-collapse collapse ">
                    ...
                    foreach ($mahasiswaAll as $mhs) {
                        ...
                        Html::a('View Report', ['baak', 'nim' => $mhs->nim, 'kelas_id' =>$kelas->kelas_id], ['class' => 'btn btn-info']) .
                        " </td></tr>";
